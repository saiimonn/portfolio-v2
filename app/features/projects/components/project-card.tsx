      ...
      <div className="group flex h-full flex-col space-y-4 border-b border-b-gray-300/20 py-8">
        ...
        <div className="space-y-4">
          ...
          <div className = "flex flex-row gap-2">
            {repoLink && (
              <Link href = {repoLink} className = "border rounded-full py-2 px-4 bg-white text-black hover:bg-white/20 hover:text-white ease-in transition-colors">
                Repository
              </Link>
            )}
            
            {siteLink && (
              <Link href={siteLink} className="border rounded-full py-2 px-4 bg-white text-black hover:bg-white/20 hover:text-white ease-in transition-colors">
                Website
              </Link>
            )}
          </div>
