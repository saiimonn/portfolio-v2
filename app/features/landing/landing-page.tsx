...
const LandingPage = () => {
  ...
  return (
    <div ref = {container}>
      <div className="relative w-full font-sans transition-opacity duration-500">
        {/* --- HERO SECTION --- */}
          ...
          <div className="relative flex flex-col justify-between h-full w-full p-8 md:p-16 z-30">
            ...
            <div className="flex flex-row justify-between items-end w-full">
              <div className = "text-white sticky">
                <h1 className="text-7xl md:text-8xl text-[#FFFFF0] font-extrabold tracking-tighter leading-none">Saiimonn</h1>
                <h3 className="text-xl md:text-4xl opacity-70">Web Development • Machine Learning</h3>
              </div>
