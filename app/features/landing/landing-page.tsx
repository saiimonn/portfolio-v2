...
const LandingPage = () => {
  return (
    <div className="relative w-full font-sans">
      ...
      {/* --- STICKY HERO SECTION --- */}
      <section className="sticky top-0 h-screen w-full overflow-hidden z-0 bg-black">
      ...
      <main className="relative z-40 bg-[#121212] shadow-[0_-20px_50px_rgba(0,0,0,0.8)]">
        <section className="flex w-full h-auto py-32 px-8 text-white border-b border-white/5">
        ...
        <div className="py-24 bg-[#0a0a0a] border-b border-white/5"><TechCarousel /></div>
        <section className="p-12"><ProjectList /></section>

        <footer className="bg-black border-t border-white/10 p-24 text-center">
          <p className="text-white opacity-50 text-sm tracking-widest uppercase">© 2026 Simon Gementiza</p>
        </footer>
      </main>
    </div>
  );
