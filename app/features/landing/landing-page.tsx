...
import TechCarousel from "@/app/(pages)/landing/components/techCarousel";
import ProjectList from "@/app/(pages)/landing/components/projectList";
  ...
  return (
    <div className="relative w-full font-sans">
      ...
      <section className="sticky top-0 h-screen w-full overflow-hidden z-0">
        <div className="grain-overlay opacity-[0.06] z-20" />
        ...
        <div className="relative flex flex-col justify-between h-full w-full p-8 md:p-16 z-30">
          <div className="flex items-center w-full h-full">
            <div className="flex flex-row items-center w-full">
              <div className="flex flex-col text-white w-[60%]">
                ...
                <div className="mt-4">
                  <h3 className="text-2xl md:text-3xl font-semibold opacity-70">Web Development</h3>
                  <h3 className="text-2xl md:text-3xl font-semibold opacity-70">Machine Learning</h3>
                </div>
              </div>
          ...
          <div className="flex flex-row justify-end items-end w-full">
            <div className="text-right text-white">
              <h2 className="text-3xl md:text-6xl font-bold">Full-Stack Developer</h2>
              <h2 className="text-xl md:text-4xl opacity-70">Based in Cebu, Philippines</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="relative z-40 bg-[#121212] shadow-[0_-20px_50px_rgba(0,0,0,0.8)]">
        {/* About Me Section */}
        <div className="flex w-full h-auto pt-28 mb-28 px-8 text-white">
        ...
        {/* Footer */}
        <footer className="bg-black border-t border-white/10 pt-24 pb-12 px-8 md:px-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h4 className="text-sm text-gray-500 uppercase tracking-widest mb-4">Get in touch</h4>
              <p className="text-2xl md:text-4xl text-white font-medium hover:text-blood transition-colors underline decoration-1 underline-offset-8">
                gementizasgg08@gmail.com
              </p>
            </div>
            <div className="flex flex-col items-end">
              <h4 className="text-sm text-gray-500 uppercase tracking-widest mb-4">Social</h4>
          ...
          <div className="mt-32 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between text-gray-500 text-sm">
