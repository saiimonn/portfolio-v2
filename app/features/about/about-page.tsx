...
const socials = [
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/simon-gabriel-gementiza-9abb59279/",
  },
];
          ...
          <div className="space-y-8 sm:space-y-10 md:space-y-12 leading-relaxed text-sm sm:text-base">
            <div>
              ...
              <p className="fade-reveal text-base sm:text-lg text-white font-light">
                ...
                full-stack web projects with a focus on modern architecture.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="fade-reveal mb-6 text-base sm:text-lg">
                ...
                <Link href="mailto:gementizasgg08@gmail.com">
                  <span className="text-white border-b border-zinc-700 hover:border-white transition-colors cursor-pointer">
                    {" "}
